...
= 2.10.5 =
Housekeeping release. The database classes now limit their code suppressions to the exact blocks that need them, so any query added in the future is checked by the security rules. No query and no behaviour changed.
