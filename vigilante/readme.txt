...
= 2.11.1 =
Fixes a false positive in the remote file inclusion rule that stopped the block editor from embedding YouTube and any other oEmbed. The firewall now records the blocked address in a readable form and shows it in the activity log.
