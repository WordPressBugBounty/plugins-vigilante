...
= 2.11.0 =
Security release. Closes a second-factor bypass through login forms other than wp-login.php, and the login lockout now works on sites outside UTC. Every remembered device must pass the second factor once more. The login screen no longer reveals whether an account exists.
